...
export default function ContractCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setContractName(initialValues.contractName);
    setContractLocation(initialValues.contractLocation);
    setContractBushels(initialValues.contractBushels);
    setContractDollars(initialValues.contractDollars);
    setRemainingBushels(initialValues.remainingBushels);
    setRemainingDollars(initialValues.remainingDollars);
